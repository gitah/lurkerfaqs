    ...
    def retrieve(self):
        ...
        while True:
            try:
                ...
                logger.debug("Reached end of board %s at page %s" % (self.board.url, pg))
                break;
            except Exception as e:
                # TODO: emit metric for exception
                logger.error("Error scrapping board %s, page %s: %s" % (self.board.url, pg, str(e)))
